...
class ZenlessZoneZeroExecutionStrategy extends ExecutionStrategyDefinition<RunBottleExecutablePayload> {
  readonly providerId = "hoyo:zzz";
  readonly strategyId = "hoyo:zzz.launch";
...
export const ZZZ_EXECUTION_STRATEGY = new ZenlessZoneZeroExecutionStrategy();
